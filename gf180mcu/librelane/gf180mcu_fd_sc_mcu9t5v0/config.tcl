...
set ::env(SYNTH_CLK_DRIVING_CELL) "$::env(STD_CELL_LIBRARY)__clkinv_4/ZN"
...
set ::env(CELL_PAD_EXCLUDE) "$::env(STD_CELL_LIBRARY)__filltie $::env(STD_CELL_LIBRARY)__fill_*  $::env(STD_CELL_LIBRARY)__fillcap_* $::env(STD_CELL_LIBRARY)__endcap"
...
set ::env(TRISTATE_CELLS) "$::env(STD_CELL_LIBRARY)__bufz* $::env(STD_CELL_LIBRARY)__invz* $::env(STD_CELL_LIBRARY)__hold"
